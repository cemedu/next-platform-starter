...
const CourseDetailsCard = ({ data, user, courses = [] }) => {
    ...
    const GetComments = async (d) => {
        ...
        if (success) {
            if (ratings.length < 1) {
                toast.success('No ratings found!');
            }
            setReting(ratings)
            ...
            <div className='bg-[var(--bg2)] rounded-md sm:p-4'>
                <div className='cource_details'>
                    ...
                    <div>
                        ...
                        <br />
                        <div>
                            <h2 className='text-2xl font-bold text-[var(--text1)] py-2'>Covered topics </h2>
                ...
                <br />
                <div><h2 className='text-2xl font-bold text-[var(--text1)] py-2'>Other Courses</h2></div>
                <hr />
                <br />
                <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
                    {courses.length > 0 ? courses.map((x, i) => (
